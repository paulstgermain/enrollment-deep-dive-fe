const fakeData = [
	{
		transcript:
			"Speaker 1: What's the duration of the bootcamp? \n" +
		...
		date_created: new Date("2023-08-10T10:00:00Z"),
		...
		fireflies_summary:
			"Discussion about bootcamp duration and materials required.",
		ec_checklist: {
	...
	{
		transcript:
			"Speaker 1: Do I need prior coding experience to join? \n" +
		...
		date_created: new Date("2023-08-01T11:30:00Z"),
		...
		fireflies_summary:
			"Inquiries about prerequisites and preparation courses.",
		ec_checklist: {
	...
	{
		transcript:
			"Speaker 1: How many students are there in each cohort? \n" +
		...
		date_created: new Date("2023-08-08T15:20:00Z"),
		...
		fireflies_summary:
			"Questions about class size, mentorship, and personal guidance.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: Is remote learning an option? \n" +
		...
		date_created: new Date("2023-08-12T14:45:00Z"),
		...
		fireflies_summary:
			"Discussion on remote versus on-site learning options and their quality.",
		ec_checklist: {
			time_availability: false,
	...
	{
		transcript:
			"Speaker 1: What post-bootcamp support do you provide? \n" +
		...
		date_created: new Date("2023-08-07T16:10:00Z"),
		...
		fireflies_summary:
			"Inquiries about post-bootcamp support, job placements, and course material access.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: false,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: Are there any financing options available? \n" +
		...
		date_created: new Date("2023-08-15T11:00:00Z"),
		...
		fireflies_summary:
			"Discussion about financing options, loans, and income share agreements.",
		ec_checklist: {
			time_availability: false,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: I'm from a non-tech background. Will I be able to keep up? \n" +
		...
		date_created: new Date("2023-08-13T12:45:00Z"),
		...
		fireflies_summary:
			"Inquiries about suitability for people from non-tech backgrounds and beginner resources.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: How often are the cohorts started? \n" +
		...
		date_created: new Date("2023-08-20T14:00:00Z"),
		...
		fireflies_summary:
			"Discussion about cohort frequency and the admission screening process.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: false,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: What if I need to drop out midway? Is there a refund policy? \n" +
		...
		date_created: new Date("2023-08-17T15:30:00Z"),
		...
		fireflies_summary:
			"Questions about refund policy and possibility of rejoining after dropping out.",
		ec_checklist: {
			time_availability: false,
			commitment_readiness: false,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: I'm an international student. Do you provide visa support? \n" +
		...
		date_created: new Date("2023-08-19T16:40:00Z"),
		...
		fireflies_summary:
			"Inquiries about provisions for international students and visa support.",
		ec_checklist: {
			time_availability: false,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: Can I work part-time while attending the bootcamp? \n" +
		...
		date_created: new Date("2023-08-23T09:00:00Z"),
		...
		fireflies_summary:
			"Discussion about managing part-time work alongside the bootcamp and availability of evening classes.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: How is the curriculum updated? Do you incorporate the latest tech trends? \n" +
		...
		date_created: new Date("2023-08-24T10:30:00Z"),
		...
		fireflies_summary:
			"Queries about curriculum updates, latest tech trends, and cloud technologies.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: What's the student to teacher ratio in the bootcamp? \n" +
		...
		date_created: new Date("2023-08-25T11:15:00Z"),
		...
		fireflies_summary:
			"Discussion on student to teacher ratio and availability of teaching assistants.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: true,
			why_join: false,
	...
	{
		transcript:
			"Speaker 1: I've heard about your diversity scholarships. Can you tell me more? \n" +
		...
		date_created: new Date("2023-08-26T14:00:00Z"),
		...
		fireflies_summary:
			"Questions about diversity scholarships, criteria, and application deadlines.",
		ec_checklist: {
			time_availability: false,
			commitment_readiness: true,
			why_join: true,
	...
	{
		transcript:
			"Speaker 1: How is the job placement process managed? \n" +
		...
		date_created: new Date("2023-08-27T15:45:00Z"),
		...
		fireflies_summary:
			"Discussion on job placement services, career support, and average graduate salaries.",
		ec_checklist: {
			time_availability: true,
			commitment_readiness: false,
			why_join: true,
